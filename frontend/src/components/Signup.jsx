...
function Signup() {
  ...
  const signup = async (e) => {
    ...
    try {
      const response = await fetch("https://todo-app-server-zeta-sage.vercel.app/api/v1/user/register", {
        method: "POST",
      ...
      <div className="w-full max-w-md">
        <div className="bg-white rounded-xl shadow-2xl overflow-hidden">
          <div className="bg-gradient-to-r from-indigo-600 to-blue-600 p-6 text-center">
            ...
            <p className="text-indigo-100 mt-2">Join us to start organizing your tasks</p>
          </div>
